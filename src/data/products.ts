...
export const products: Product[] = [
    ...
    {
        id: "3",
        slug: "brass-pooja-lota",
        name: "Brass Pooja Lota",
        price: 799,
        description:
            "Traditional brass Lota (Kalash) for daily pooja rituals. Handmade with a perfectly balanced shape for easy handling during Abhishekam. The wide mouth facilitates easy filling and pouring of sacred water.",
        shortDescription: "Traditional handmade brass Lota for daily pooja",
        category: "Pooja Essentials",
        material: "Pure Brass",
        weight: 0.4,
        height: 5,
        images: ["/images/products/lota-1.jpg"],
        mainImage: "/images/products/lota-1.jpg",
        vastuDirection: "North-East",
        careInstructions:
